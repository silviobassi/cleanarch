...
public class ProductUnitTest1
{
    ...
    [Fact]
    public void CreateProductId_WithNullImageValue_DomainExceptionValidation()
    {
        Action action = () => new Product(
            1, "Product Name", "Product Description", 100, 10,
            null, 1);
    ...
    {
        Action action = () => new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        action.Should().NotThrow<DomainExceptionValidation>();
    }
    ...
    {
        Action action = () => new Product(null, "Product Description", 100, 10,
            "product-image.png", 1);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid name. Name is required");
    }
    ...
    {
        Action action = () => new Product("Pr", "Product Description", 100, 10,
            "product-image.png", 1);
        action.Should().Throw<DomainExceptionValidation>()
            .WithMessage("Invalid name. Name must have at least 3 characters");
    }
    ...
    {
        Action action = () => new Product("Product Name", null, 100, 10,
            "product-image.png", 1);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid description. Description is required");
    }
    ...
    {
        Action action = () => new Product("Product Name", "Prod", 100, 10,
            "product-image.png", 1);
        action.Should().Throw<DomainExceptionValidation>()
            .WithMessage("Invalid description. Description must have at least 5 characters");
    }
    ...
    {
        Action action = () => new Product("Product Name", "Product Description", -1, 10,
            "product-image.png", 1);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid price value");
    }
    ...
    {
        Action action = () => new Product("Product Name", "Product Description", 100, -1,
            "product-image.png", 1);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid stock value");
    }
    
    [Fact]
    public void CreateProductWithoutId_WithNullImageValue_DomainExceptionValidation()
    {
        Action action = () => new Product("Product Name", "Product Description", 100, 10,
            null, 1);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid image. Image is required");
    ...
    public void UpdateProduct_WithValidParameters_ResultObjectValidState()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Product Name Updated", "Product Description Updated", 200, 20,
    ...
    public void UpdateProduct_WithNullNameValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update(null, "Product Description Updated", 200, 20,
            "product-image-updated.png", 2);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid name. Name is required");
    }
    ...
    public void UpdateProduct_WithShortNameValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Pr", "Product Description Updated", 200, 20,
            "product-image-updated.png", 2);
        action.Should().Throw<DomainExceptionValidation>()
            .WithMessage("Invalid name. Name must have at least 3 characters");
    }
    ...
    public void UpdateProduct_WithNullDescriptionValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Product Name Updated", null, 200, 20,
            "product-image-updated.png", 2);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid description. Description is required");
    }
    ...
    public void UpdateProduct_WithShortDescriptionValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Product Name Updated", "Prod", 200, 20,
            "product-image-updated.png", 2);
        action.Should().Throw<DomainExceptionValidation>()
            .WithMessage("Invalid description. Description must have at least 5 characters");
    }
    ...
    public void UpdateProduct_WithNegativePriceValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Product Name Updated", "Product Description Updated", -1, 20,
            "product-image-updated.png", 2);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid price value");
    }
    ...
    public void UpdateProduct_WithNegativeStockValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Product Name Updated", "Product Description Updated", 200, -1,
            "product-image-updated.png", 2);
        action.Should().Throw<DomainExceptionValidation>().WithMessage("Invalid stock value");
    }
    
    [Fact]
    public void UpdateProduct_WithNullImageValue_DomainExceptionValidation()
    {
        var product = new Product("Product Name", "Product Description", 100, 10,
            "product-image.png", 1);
        Action action = () => product.Update("Product Name Updated", "Product Description Updated", 200, 20,
